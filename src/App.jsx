...
export default function App() {
  ...
  const [googleScriptUrl, setGoogleScriptUrl] = useState('https://script.google.com/macros/s/AKfycbyUUaETU3lY52gCMadjDMiXQZ-lQxegqFNwXsaDB2pvoYh0uci_l3VlQB2gOVmF-upW/exec');
